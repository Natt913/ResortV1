...
public class HousekeepingController {
    ...
    public void initialize(){
        ObservableList<Request> selectedRequests = Request.getSelectedRequestList( EMPTYPES.HOUSEKEEPING.ordinal() );
    ...
    private void onSelectCell() {
        ...
        {
            request = requestsTable.getSelectionModel().getSelectedItem();
        }
    }
